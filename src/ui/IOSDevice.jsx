// iOS 26 (Liquid Glass) 風デバイスフレーム — アセット・依存なし
function StatusBar({ dark = false, time = '9:41' }) {
  const c = dark ? '#fff' : '#000'
  return (
    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '21px 24px 19px', boxSizing: 'border-box', position: 'relative', zIndex: 20, width: '100%' }}>
...
export default function IOSDevice({ children, width = 400, height = 840, dark = false }) {
  return (
    <div style={{
