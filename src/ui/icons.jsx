...
export const ICON_PATHS = {
  ...
  walkin: ['M15 3h4a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2h-4', 'm10 17 5-5-5-5', 'M15 12H3'],
  ...
  // 卒業証書: リボンの付いた賞状
  cert: ['M5 3h14a1 1 0 0 1 1 1v10a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1z', 'M8 7h8', 'M8 11h5', 'M9 15v6l3-2 3 2v-6'],
  // 請求突き合わせ: 電卓と照合のチェック
  billing: ['M8 2h8a2 2 0 0 1 2 2v16a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2z', 'M9 6h6', 'M9 10h.01', 'M12 10h.01', 'M15 10h.01', 'M9 14h.01', 'M12 14h.01', 'm14.5 17.5 1.5 1.5 3-3'],
  /* ID検索: 虫めがねの中に人。「人を探す」＝氏名と生年月日から台帳の ID を引く、の意。
     ほかの項目には絵があるのにここだけ空白だった（2026-09-24 ユーザー指摘）。
     ros（人）・csv（人＋追加）・search（虫めがね）とは別の形にしてある。 */
  idlookup: [
    'M10.5 18a7.5 7.5 0 1 0 0-15 7.5 7.5 0 0 0 0 15',   // レンズ
    'M21 21l-4.7-4.7',                                   // 柄
    'M10.5 10.5a2 2 0 1 0 0-4 2 2 0 0 0 0 4',            // 頭
    'M7 14.6a3.6 3.6 0 0 1 7 0',                         // 肩
  ],
  // 重複の統合: 2 本の線が 1 本に合流する形
  merge: ['M6 3v6a4 4 0 0 0 4 4h8', 'M18 3v6a4 4 0 0 1-4 4h-4', 'm15 10 3 3-3 3', 'M12 13v8'],
  ...
  techo: ['M4 19.5A2.5 2.5 0 0 1 6.5 17H20', 'M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z'],
  techolist: ['M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z', 'M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z'],
  csv: ['M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2', 'M9 11a4 4 0 1 0 0-8 4 4 0 0 0 0 8', 'M19 8v6', 'M22 11h-6'],
  /* CSV 出力: 書類から外へ出ていく矢印。ここも絵が無く空白だった（2026-09-24 同時に発見）。
     pdf（下向き＝手元に落とす）とは向きを変えて、出す側だと分かるようにしている。 */
  exp: ['M12 3H6a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-6', 'M15 3h6v6', 'M21 3l-8 8', 'M8 13h5', 'M8 17h4'],
