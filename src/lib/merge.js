...
/* 生年月日の数字だけ（1948/07/30 → 19480730、1948 → 1948）。
   ...
   ★0詰めされていない書き方（1948/5/12）を揃える（2026-09-23）。
     揃えないと数字が7桁になり、下の similarity が「年月日まで分かっている」と見なさず、
     生年月日が一致しても加点されない＝同じ人が見つからないことがある。
     本番の台帳432名では、点区切り（1948.5.12）が2名・年だけが32名いる。 */
export const birthDigits = (s) => {
