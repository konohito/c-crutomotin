...
// 結果票などで項目を一覧するときの短縮ラベル（公式 No → 短い表現）
export const KCL_SHORT = {
  1: 'バス・電車で外出', 2: '日用品の買い物', 3: '預貯金の出し入れ', 4: '友人の家を訪問', 5: '家族・友人の相談',
  6: '階段の昇り降り', 7: '椅子から立ち上がる', 8: '15分続けて歩く', 9: '転倒歴あり', 10: '転倒の不安',
  11: '体重が減った', 12: 'BMI 18.5 未満', 13: '固いものが食べにくい', 14: 'むせる', 15: '口の渇き',
  16: '週1回以上の外出', 17: '外出が減った', 18: '物忘れの指摘', 19: '電話をかける', 20: '日付がわからない',
  21: '充実感がない', 22: '楽しめない', 23: 'おっくうに感じる', 24: '役に立たないと感じる', 25: 'わけもなく疲れる',
}
