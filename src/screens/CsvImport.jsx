...
const CSV_COLS = ['参加者ID', '氏名', 'かな（ふりがな）', '生年月日', '性別', '電話番号', '５ｍ通常歩行', '開眼片足立ち 右', '開眼片足立ち 左', '握力 右', '握力 左', 'TUG', '身長', '体重']
  ...
  return (
    <div className="screen" style={{ maxWidth: 860 }}>
      ...
      >
        ...
        <div style={{ fontSize: 15.5, fontWeight: 700, marginTop: 4 }}>名簿・記録の CSV をここにドラッグ＆ドロップ</div>
        <div style={{ fontSize: 12.5, color: 'var(--fg-3)' }}>Excel からの書き出し（Shift_JIS / UTF-8）に対応 · 1 行 = 1 名</div>
      ...
      <Card pad>
        <div style={{ display: 'flex', alignItems: 'baseline', justifyContent: 'space-between' }}>
          ...
          <div style={{ fontSize: 11.5, color: 'var(--fg-3)' }}>順不同 · 一部だけでも OK</div>
        </div>
